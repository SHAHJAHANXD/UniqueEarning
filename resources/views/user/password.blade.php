    ...
    <div class="wrapper bg-white profilee">
        ...
        <?php
                    if (isset($employee->id) && $employee->id != 0) {
                        $url = url('update-password' . $employee->id ?? '');
                    } else {
        ...
        <div class="py-2">
            <div class="row py-2">
                <div class="col-md-6"> <label for="firstname">Old Password</label> <input type="password" class="bg-light form-control" placeholder="********"  name="password"> </div>
                <div class="col-md-6 pt-md-0 pt-3"> <label for="lastname">New Password</label> <input type="password" class="bg-light form-control" placeholder="********"  name="new_password"> </div>
            </div>
